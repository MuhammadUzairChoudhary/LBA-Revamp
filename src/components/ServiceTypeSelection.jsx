...
const RingIcon = ({ className }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path
      ...
      strokeWidth={1.5}
      d="M12 8c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm-4 4l-2 2M16 12l2 2M12 4V2M12 20v-2M4 12H2M22 12h-2"
    />
  </svg>
)
...
const MakeupIcon = ({ className }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 14V3" />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M14 18c-2.76 0-5-2.24-5-5h10c0 2.76-2.24 5-5 5z"
    />
              ...
              >
                <div className="relative flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
                  ...
                  <div className="flex-1 min-w-0">
                    <div
                      className={`font-light text-base sm:text-lg leading-tight transition-colors ${
        ...
        {errors.service_type && (
          <div className="mb-6 p-4 bg-red-900/50 border border-red-700 rounded-lg shadow-xl shadow-red-900/20">
            <div className="flex items-center">
              ...
              <p className="text-red-200 text-sm font-light">Please select a service type to continue</p>
            </div>
          </div>
        )}
