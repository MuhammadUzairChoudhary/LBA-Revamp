...
// Clean & minimal Location Pin Icon
      ...
      <div className="bg-white rounded-2xl p-5 sm:p-8 border border-gray-200 shadow-2xl shadow-gray-400/20">
        ...
        <div className="text-center mb-4 sm:mb-10">
          ...
          <p className="text-gray-600 text-sm sm:text-base font-light max-w-2xl mx-auto">
            Enter or confirm your studio location details below
          </p>
        </div>
        ...
        <div className="">
          <div
            className="
              relative w-full p-5 sm:p-8 rounded-2xl transition-all duration-300 text-left overflow-hidden
              border border-gray-300 
              bg-gradient-to-br from-gray-100 via-gray-50 to-white
              shadow-lg shadow-gray-300/20
            "
          >
            <div className="absolute inset-0 bg-gradient-to-br from-gray-200/10 via-gray-300/10 to-gray-400/10 blur-xl"></div>

            {/* Main Content */}
            <div className="relative flex items-start gap-3 sm:gap-6 flex-wrap sm:flex-nowrap">
              {/* Smaller Icon */}
              <div
                className="
                  flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center rounded-lg 
                  bg-gradient-to-br from-gray-200/40 to-gray-300/30
                  shadow-md border border-gray-300/40
                "
              >
                <LocationPinIcon className="w-5 h-5 sm:w-6 sm:h-6 text-gray-700" />
              </div>

              {/* Text Section */}
              <div className="flex-1 min-w-0">
                <h3 className="text-lg sm:text-2xl font-light text-gray-900 sm:mb-3 leading-tight">
                  Our Studio Location
                </h3>

                <div className="space-y-0.5 text-gray-700 ">
                  <p className="text-base sm:text-lg font-medium">{studioAddress.name}</p>
                  <p className="text-sm sm:text-base font-light">{studioAddress.street}</p>
