...
export default function BookingHeader({ step, getTotalSteps, getStepTitle, isEditMode }) {
  ...
  return (
    <div className="text-center px-2 sm:px-4 max-w-[100%] sm:max-w-3xl mx-auto">
      <div className="flex justify-center mb-4">
        <img
          src="src/assets/Black(1).png"
          alt="Logo"
          className="w-[230px] mt-[-20px] sm:w-[180px] sm:mt-[-10px] md:w-[200px] md:mt-[-15px] lg:w-[280px] lg:mt-[-20px]"
        />
      ...
      <p
        className="text-sm sm:text-base text-gray-600 font-light max-w-2xl mx-auto mb-6"
        style={{ letterSpacing: "0.01em" }}
      >
      ...
      <div className="mt-6 max-w-2xl mx-auto p-3 sm:p-4 rounded-xl bg-gray-50 backdrop-blur-sm border border-gray-300 shadow-xl shadow-gray-400/20">
        ...
        {/* <div className="text-center mt-3">
          <p className="text-xs sm:text-sm font-medium text-gray-900 tracking-wide">{getStepTitle()}</p>
        </div> */}
      </div>
    </div>
  )
