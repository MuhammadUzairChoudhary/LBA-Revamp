...
// Custom Date Picker Component (Light + Charcoal Theme)
...
// Custom Time Picker (Light + Charcoal Theme)
  ...
  return (
    <div>
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        {isOpen && (
          <div className="absolute z-50 w-full mt-2 bg-white border border-gray-300 rounded-xl shadow-xl overflow-hidden">
            <div className="max-h-64 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100">
              {timeOptions.map((t, i) => (
                <button
                  ...
                  className="w-full px-4 py-2.5 text-left bg-gray-200 text-gray-800 hover:bg-gray-800 hover:text-gray-200 transition-colors border-b border-gray-100 last:border-b-0 text-sm font-light"
                >
                  {t.label}
                </button>
              ))}
  ...
  return (
    <div className="max-w-3xl mx-auto px-2 sm:px-4 py-6 sm:py-8">
      <div className="bg-white rounded-2xl p-5 sm:p-8 border border-gray-200 shadow-2xl shadow-gray-400/20">
        <div className="mb-10 sm:mb-5 text-center">
          <h2 className="text-2xl sm:text-3xl font-light text-gray-900 mb-3 tracking-wide">
            Service Details<span className="text-gray-400 ml-2 font-normal">*</span>
          </h2>
