     ...
     <div className="max-w-3xl mx-auto px-2 sm:px-4 py-6 sm:py-8">
      <div className="bg-white rounded-2xl p-5 sm:p-8 border border-gray-200 shadow-2xl shadow-gray-400/20">
        ...
        <form onSubmit={handleSubmit}>
          <div className="space-y-6 mb-5 sm:mb-16">
            <div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <label
                    key={addon}
                    className="flex items-center gap-3 px-4 py-3 rounded-xl border border-gray-300 bg-gray-50 hover:bg-gray-100 transition-all duration-200 cursor-pointer shadow-sm"
                  >
                    <input
                      type="checkbox"
                      {...register("addons")}
...
// export default function BrideAddons({
//   register,
//   watch,
//   errors,
//   onNext,
...
//   const brideService = watchedFields.bride_service;
...
//   console.log("🔍 BrideAddons - hijabSetting watch:", hijabSetting);

//   // Show extensions option always, like the original website (Logic retained)
//   const showExtensions = true;

//   // The original component did not have a defined isNextEnabled state.
...
//                   Professional installation of clip-in hair extensions.
//                 </p>
...
//                 >
//                   *Note: We do not provide the hair extensions. Bride must have
//                   her own.
//                 </p>
//               </div>
...
//           {/* Hijab Setting - Section Box (Dark Mode) - NEW FEATURE */}
//           <div className="border border-gray-700/50 rounded-xl p-6 md:p-8 lg:p-10 bg-gray-800/50 shadow-inner shadow-gray-900/30">
//             <div className="mb-4 md:mb-6">
//               <h3 className="text-lg md:text-xl font-light text-white mb-2">
//                 Hijab Setting
...
//                 <h4 className="font-semibold text-rose-200 mb-2">
//                   Selected Add-ons:
//                 </h4>
//                 <ul className="text-sm md:text-base text-gray-300 space-y-1 ml-4 list-disc marker:text-rose-400">
//                   {jewelrySetting === "Yes" && (
//                     <li>Jewelry & Dupatta/Veil Setting</li>
//                   )}
//                   {extensions === "Yes" && (
//                     <li>Hair Extensions Installation</li>
//                   )}
//                   {sarhiDripping === "Yes" && <li>Saree Draping</li>}
//                   {hijabSetting === "Yes" && <li>Hijab Setting</li>}
//                 </ul>
//               </div>
//             )}
//           </div>
